...
function Mill(db, site) {
  var client = new DB(db);
  site = site || "mill";
  this.page_tmpl = new Page_tmpl(client, site);
  this.theme_tmpl = new Theme_tmpl(client, site);
  this.route = new Route(client, site);
  this.page = new Page(client, site);
  this.user = new User(client, site);
}
